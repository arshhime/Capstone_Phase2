        ...
        <AnimatePresence>
            {isOpen && (
                <>
                    ...
                    >
                        <div className="bg-zinc-900 border border-zinc-800 w-full max-w-4xl h-[80vh] rounded-3xl shadow-2xl overflow-hidden flex flex-col pointer-events-auto relative">
                            ...
                            <div className="p-4 border-b border-zinc-800 flex gap-4 bg-zinc-900/30">
                                <div className="relative flex-1">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-zinc-950 border border-zinc-800 rounded-xl pl-10 pr-4 py-2.5 text-sm text-white focus:outline-none focus:border-violet-500/50 placeholder:text-zinc-600 transition-all"
                                    />
                                </div>
                                <div className="relative">
                                    ...
                                    <select
                                        ...
                                        className="bg-zinc-950 border border-zinc-800 rounded-xl pl-10 pr-8 py-2.5 text-sm text-white focus:outline-none focus:border-violet-500/50 appearance-none cursor-pointer hover:bg-zinc-900 transition-colors"
                                    >
                                ...
                                {loading ? (
                                    ...
                                    <div className="grid gap-2">
                                        ...
                                        {problems.map((problem) => (
                                            ...
                                            >
                                                <div className="col-span-1">
                                                    {/* Status Placeholder - Ideally check usage history */}
                                                    <Circle className="w-4 h-4 text-zinc-700" />
                                                </div>
                                                <div className="col-span-6 font-medium text-zinc-200 group-hover:text-white transition-colors truncate">
