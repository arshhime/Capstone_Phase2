...
DATA_PATH = r"C:\Users\kshit\Downloads\display-problems.json"
...
def ingest():
    ...
    print(f"Creating embeddings for {len(documents)} documents using Local HuggingFace (all-MiniLM-L6-v2)...")
